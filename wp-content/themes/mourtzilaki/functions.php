...
add_action( 'acf/init', function () {
    ...
    acf_add_local_field_group( array(
        ...
        'fields'   => array(
            ...
            array( 'key' => 'field_mz_s_logo_h',       'label' => 'Μέγιστο ύψος logo (px)', 'name' => 'site_logo_height', 'type' => 'number', 'placeholder' => '200', 'min' => 16, 'max' => 400,
                   'instructions' => 'Default: 200px (desktop, αυτόματο σε mobile). Το logo σμικραίνει αναλογικά αν είναι πιο πλατύ από τον διαθέσιμο χώρο.' ),
            array( 'key' => 'field_mz_s_logo_w',       'label' => 'Μέγιστο πλάτος logo (px)', 'name' => 'site_logo_width', 'type' => 'number', 'placeholder' => '', 'min' => 60, 'max' => 800,
                   'instructions' => 'Προαιρετικό. Άδειο = όσο επιτρέπει το container.' ),
...
/* =====================================================================
 * One-time seed: pre-fill ACF fields on every static page with the
 * default content so admins see the existing structure on first edit.
 * Idempotent: only fills fields that are currently empty. Bumping the
 * version constant re-runs against newly-added (still-empty) fields.
 * =================================================================== */
add_action( 'acf/init', 'mourtzilaki_seed_static_pages_content', 50 );
function mourtzilaki_seed_static_pages_content() {
    $version = '1.0';
    if ( get_option( 'mourtzilaki_static_pages_seeded' ) === $version ) { return; }
    ...
    $glossary_default = "Α | Αγωγή | Το δικόγραφο με το οποίο εισάγεται μια αστική υπόθεση στο δικαστήριο. Ο εναγόμενος καλείται να απαντήσει εντός συγκεκριμένης προθεσμίας.\n" .
    ...
    $defaults = array(
        'about' => array(
            'about_manifesto_eyebrow' => 'Manifesto',
            'about_manifesto_text'    => '<p>Πιστεύουμε ότι κάθε νομική υπόθεση κρύβει έναν άνθρωπο. Δεν υπάρχουν «μικρές» υποθέσεις — μόνο υποθέσεις που χρειάζονται την ίδια προσοχή, σαφήνεια και αφοσίωση που θα δίναμε αν μας αφορούσαν προσωπικά.</p>',
            'about_manifesto_attr'    => '— Έλενα Μουρτζιλάκη, Ιδρύτρια',
            'about_story_title'       => 'Η ιστορία μας',
            'about_story_heading'     => 'Από μια ιδέα, ένα γραφείο.',
            'about_story_text'        => '<p>Το γραφείο ιδρύθηκε από την Έλενα Μουρτζιλάκη το 2005, με αφετηρία μια απλή ιδέα: να προσφέρουμε νομικές υπηρεσίες υψηλού επιπέδου με σαφή στρατηγική και διαρκή ενημέρωση του πελάτη.</p>',
            'about_story_p2'          => "<p>Η εμπειρία μας στα δικαστήρια, οι σύνθετες υποθέσεις που χειριστήκαμε και — πάνω απ' όλα — οι σχέσεις εμπιστοσύνης που χτίσαμε με κάθε πελάτη συνθέτουν το γραφείο που είμαστε σήμερα. Δεν είμαστε εδώ απλώς για να γράφουμε δικόγραφα.</p>",
            'about_story_year'        => '2005',
            'about_story_mini'        => "20+ | χρόνια πορείας\n800+ | υποθέσεις\n8 | τομείς εξειδίκευσης",
            'about_pillars_eyebrow'   => 'Πυλώνες',
            'about_pillars_heading'   => 'Οι αρχές που μας οδηγούν',
            'about_pillars_lead'      => '<p>Τέσσερις αρχές που καθορίζουν τον τρόπο που εργαζόμαστε. Όχι slogan — οδηγός για κάθε απόφαση.</p>',
            'about_values'            => "Διαφάνεια | Σας λέμε τι μπορεί ρεαλιστικά να γίνει — όχι ό,τι θα θέλατε να ακούσετε. Καθαρό κόστος, καθαρά χρονοδιαγράμματα.\nΣυνέπεια | Τήρηση προθεσμιών, σεβασμός χρόνου, διαρκής ενημέρωση. Καμία εξαφάνιση μετά την ανάθεση.\nΕξειδίκευση | Δεν αναλαμβάνουμε υποθέσεις εκτός του πεδίου μας. Όταν ναι, υπάρχει βάθος γνώσης και εμπειρίας.\nΠροσωπική σχέση | Κάθε υπόθεση χειρίζεται προσωπικά η δικηγόρος. Μιλάτε με αυτή που γράφει το δικόγραφο.",
            'about_diff_eyebrow'      => 'Τι μας ξεχωρίζει',
            'about_diff_heading'      => 'Τρεις διαφορές που έχουν σημασία.',
            'about_diff_btn_label'    => 'Δείτε τους τομείς',
            'about_diff_btn_url'      => home_url( '/services/' ),
            'about_diff_items'        => "clock | Άμεση πρόσβαση στη δικηγόρο | Δεν περνάτε από βοηθούς. Η δικηγόρος που αναλαμβάνει την υπόθεσή σας είναι αυτή που σας απαντάει στο τηλέφωνο, στο email και σε κάθε εξέλιξη.\nsun | Διαφανές κόστος, χωρίς εκπλήξεις | Πριν αναλάβουμε οποιαδήποτε ενέργεια, σας δίνουμε γραπτή πρόταση με σαφές κόστος και χρονοδιάγραμμα. Καμία κρυφή χρέωση, καμία αλλαγή ορόφου χωρίς συνεννόηση.\ncheck | Ρεαλιστική στρατηγική, πάντα | Δεν υποσχόμαστε ό,τι ο πελάτης θέλει να ακούσει. Σας λέμε τι μπορεί ρεαλιστικά να επιτευχθεί, με ποιο κόστος, σε ποιο χρόνο — και ποιοι είναι οι κίνδυνοι.",
            'about_mission_title'     => 'Η αποστολή μας',
            'about_mission_heading'   => 'Καθαρές αποφάσεις, χωρίς ορολογίες.',
            'about_mission_text'      => '<p>Η αποστολή μας είναι να μετατρέπουμε τη νομική πολυπλοκότητα σε καθαρές αποφάσεις. Θέλουμε ο κάθε πελάτης να φεύγει από το γραφείο μας ξέροντας τι ισχύει, τι θα γίνει, με ποιο κόστος και σε ποιο χρόνο.</p>',
            'about_mission_quote'     => 'Ο πελάτης πρέπει να φεύγει από το γραφείο μας ξέροντας ακριβώς πού στέκεται και τι θα κάνουμε τις επόμενες εβδομάδες. Όχι αόριστες υποσχέσεις.',
            'about_mission_quote_cite'=> '— από συζήτηση με νέο πελάτη, 2024',
            'about_cta_heading'       => 'Γνωρίστε την ομάδα μας.',
            'about_cta_lead'          => '<p>Οι δικηγόροι του γραφείου συνδυάζουν εξειδίκευση και εμπειρία σε διαφορετικούς τομείς δικαίου, με κοινό άξονα την προσωπική σχέση εμπιστοσύνης.</p>',
            'about_cta_btn1_label'    => 'Δείτε την ομάδα',
            'about_cta_btn1_url'      => home_url( '/team/' ),
            'about_cta_btn2_label'    => 'Επικοινωνία',
            'about_cta_btn2_url'      => $contact_url,
        ),
        'team' => array(
            'team_lead_p2'   => '<p>Παρέχει νομικές υπηρεσίες σε ιδιώτες και επιχειρήσεις, με έμφαση στη σαφή επικοινωνία, τον σεβασμό των προθεσμιών και την υψηλή ποιότητα νομικής τεκμηρίωσης.</p>',
            'team_lead_meta' => "Δικηγορικός Σύλλογος | Αθηνών\nΈτη εμπειρίας | 20+\nΓλώσσες | Ελληνικά · Αγγλικά",
            'team_btn1_label'=> 'Πλήρες βιογραφικό',
            'team_btn1_url'  => home_url( '/bio/' ),
            'team_btn2_label'=> 'Επικοινωνία',
            'team_btn2_url'  => $contact_url,
            'team_net_eyebrow' => 'Συνεργασίες',
            'team_net_title'   => 'Δουλεύουμε με αξιόπιστα δίκτυα.',
            'team_net_lead'    => '<p>Συνεργαζόμαστε με συμβολαιογράφους, λογιστές, οικονομικούς συμβούλους και εξειδικευμένα γραφεία στο εξωτερικό για υποθέσεις που το απαιτούν.</p>',
        ),
        'services' => array(
            'services_proc_eyebrow' => 'Διαδικασία',
            'services_proc_title'   => 'Πώς δουλεύουμε σε κάθε υπόθεση.',
            'services_proc_steps'   => "01 | Αρχική συνάντηση | Συζητάμε αναλυτικά την υπόθεση, εντοπίζουμε κρίσιμα σημεία και απαντάμε σε ό,τι σας απασχολεί.\n02 | Νομική ανάλυση | Μελετάμε τη νομοθεσία, τη νομολογία και τα συγκεκριμένα δεδομένα της υπόθεσης πριν προτείνουμε στρατηγική.\n03 | Σχέδιο ενεργειών | Σας παρουσιάζουμε καθαρά τις διαθέσιμες επιλογές, με τα πλεονεκτήματα, τους κινδύνους και το αναμενόμενο κόστος καθεμίας.\n04 | Εκτέλεση & ενημέρωση | Αναλαμβάνουμε εξ ολοκλήρου τη διαχείριση και σας ενημερώνουμε σε κάθε σημαντική εξέλιξη.",
            'services_cta_title'    => 'Δεν είστε σίγουρος αν η υπόθεσή σας εμπίπτει εδώ;',
            'services_cta_lead'     => '<p>Επικοινωνήστε μαζί μας για να αξιολογήσουμε την υπόθεση και να σας κατευθύνουμε σωστά.</p>',
            'services_cta_btn_label'=> 'Επικοινωνία',
            'services_cta_btn_url'  => $contact_url,
        ),
        'cases' => array(
            'cases_disclaimer'   => '<p><strong>Σημείωση:</strong> Όλες οι παραπάνω υποθέσεις είναι ανωνυμοποιημένες και παρουσιάζονται μόνο για ενημερωτικούς σκοπούς. Δεν συνιστούν υπόσχεση παρόμοιου αποτελέσματος σε άλλες υποθέσεις. Κάθε νομική υπόθεση κρίνεται με βάση τα δικά της δεδομένα.</p>',
            'cases_cta_title'    => 'Έχετε παρόμοια υπόθεση;',
            'cases_cta_lead'     => '<p>Κάθε υπόθεση έχει τα δικά της δεδομένα. Συζητήστε την υπόθεσή σας μαζί μας σε εμπιστευτικό ραντεβού.</p>',
            'cases_cta_btn_label'=> 'Επικοινωνία',
            'cases_cta_btn_url'  => $contact_url,
        ),
        'faq' => array(
            'faq_response_label' => '24h',
            'faq_still_eyebrow'  => 'Ακόμη ερωτήματα;',
            'faq_still_title'    => 'Δεν βρήκατε αυτό που ψάχνατε;',
            'faq_still_lead'     => '<p>Ρωτήστε μας απευθείας. Στις περισσότερες περιπτώσεις, ένα σύντομο email αρκεί για να σας προσανατολίσουμε σωστά.</p>',
            'faq_still_btn1_label' => 'Επικοινωνία',
            'faq_still_btn1_url'   => $contact_url,
            'faq_still_btn2_label' => 'Νομικό λεξικό',
            'faq_still_btn2_url'   => home_url( '/glossary/' ),
        ),
        'glossary' => array(
            'glossary_terms'        => $glossary_default,
            'glossary_cta_title'    => 'Δεν βρίσκετε όρο που σας απασχολεί;',
            'glossary_cta_lead'     => '<p>Ρωτήστε μας απευθείας. Εξηγούμε τους νομικούς όρους που σχετίζονται με την υπόθεσή σας με κατανοητό τρόπο.</p>',
            'glossary_cta_btn_label'=> 'Επικοινωνία',
            'glossary_cta_btn_url'  => $contact_url,
        ),
        'contact' => array(
            'contact_phone_hint'   => 'Δευτ — Παρ, 09:00 — 19:00',
            'contact_email_hint'   => 'Απάντηση σε 24 ώρες',
            'contact_addr_hint'    => 'Δείτε στον χάρτη →',
            'contact_form_eyebrow' => 'Φόρμα επικοινωνίας',
            'contact_form_title'   => 'Στείλτε μας μήνυμα',
            'contact_form_subtitle'=> 'Απαντάμε εντός 24 ωρών. Όλες οι επικοινωνίες είναι αυστηρά εμπιστευτικές.',
            'contact_side1_title'  => 'Ωράριο γραφείου',
            'contact_side2_title'  => 'Επείγουσες υποθέσεις',
            'contact_side2_text'   => '<p>Σε αυτόφωρη διαδικασία ή κρίσιμο ζήτημα εκτός ωραρίου, καλέστε απευθείας στο τηλέφωνο. Διαθέτουμε εφημερία για επείγοντα ποινικά & ασφαλιστικά μέτρα.</p>',
            'contact_side3_title'  => 'Online συνάντηση',
            'contact_side3_text'   => '<p>Πραγματοποιούμε συναντήσεις και μέσω Zoom ή Google Meet για πελάτες εκτός Αθήνας ή εξωτερικού. Στη φόρμα αναφέρετε «online» στο θέμα.</p>',
            'contact_social'       => "linkedin | #\nfacebook | #\ninstagram | #",
            'contact_bottom_eyebrow'=> 'Διακριτικότητα',
            'contact_bottom_title' => 'Όλες οι επικοινωνίες είναι εμπιστευτικές',
            'contact_bottom_lead'  => '<p>Η δικηγορική εμπιστευτικότητα είναι θεσμοθετημένη υποχρέωση. Καμία πληροφορία δεν διαρρέει εκτός γραφείου, ακόμη κι αν δεν ανατεθεί τελικά η υπόθεση.</p>',
        ),
        'blog' => array(
            'blog_featured_label' => 'Επιλεγμένο',
            'blog_all_eyebrow'    => 'Όλα τα άρθρα',
            'blog_all_title'      => 'Πρόσφατες δημοσιεύσεις.',
            'blog_nl_eyebrow'     => 'Newsletter',
            'blog_nl_title'       => 'Λάβετε τις σημαντικές νομικές εξελίξεις στο email σας.',
            'blog_nl_text'        => 'Μία φορά τον μήνα. Επιλεγμένες αναλύσεις. Καμία διαφήμιση.',
            'blog_nl_btn'         => 'Εγγραφή',
            'blog_cta_title'      => 'Έχετε νομικό ερώτημα που απαντά κάποιο άρθρο;',
            'blog_cta_lead'       => '<p>Ας το συζητήσουμε στο πλαίσιο ενός εμπιστευτικού ραντεβού. Σας απαντάμε σε 24 ώρες εργάσιμων ημερών.</p>',
            'blog_cta_btn_label'  => 'Επικοινωνία',
            'blog_cta_btn_url'    => $contact_url,
        ),
        'bio' => array(
            'bio_hero_badges'         => "Δ.Σ.Α.\nΠαρ' Αρείω Πάγω\nLL.M.\nΔιαμεσολαβήτρια",
            'bio_years_badge_num'     => '20+',
            'bio_years_badge_label'   => 'χρόνια εμπειρίας',
            'bio_cta_primary_label'   => 'Κλείστε ραντεβού',
            'bio_cta_primary_url'     => $contact_url,
            'bio_cta_secondary_label' => 'Δείτε την πορεία',
            'bio_cta_secondary_anchor'=> '#bio-timeline',
            'bio_stats'               => "20+ | Έτη επαγγέλματος\n800+ | Υποθέσεις\n8 | Τομείς εξειδίκευσης\n3 | Γλώσσες\n5,0★ | Αξιολογήσεις",
            'bio_philosophy_eyebrow'  => 'Φιλοσοφία',
            'bio_philosophy_quote'    => '<p>Δεν είμαι εδώ για να σας πω τι θέλετε να ακούσετε. Είμαι εδώ για να σας πω τι μπορεί ρεαλιστικά να γίνει — και να κάνω καθετί δυνατό για να γίνει.</p>',
            'bio_timeline_eyebrow'    => 'Πορεία',
            'bio_timeline_title'      => 'Σπουδές & επαγγελματική διαδρομή',
            'bio_timeline_lead'       => '<p>Από το πρώτο εξάμηνο της Νομικής μέχρι τον ανώτατο βαθμό δικηγορίας — μια διαδρομή 25+ ετών.</p>',
            'bio_timeline'            => $tl_default,
            'bio_expertise_eyebrow'   => 'Εξειδίκευση',
            'bio_expertise_title'     => 'Τομείς δικαίου που χειρίζομαι.',
            'bio_expertise_t1_title'  => 'Πρωτεύοντες',
            'bio_expertise_t1_tags'   => "Εμπορικό & Εταιρικό\nΑστικό & Ενοχικό\nΑκίνητα & Κτηματολόγιο",
            'bio_expertise_t2_title'  => 'Δευτερεύοντες',
            'bio_expertise_t2_tags'   => "Οικογενειακό\nΕργατικό\nΤραπεζικό",
            'bio_expertise_t3_title'  => 'Πρόσθετοι τομείς',
            'bio_expertise_t3_tags'   => "Διοικητικό\nΦορολογικό\nΠοινικό\nΔιαμεσολάβηση",
            'bio_memberships_eyebrow' => 'Ιδιότητες & συμμετοχές',
            'bio_memberships_title'   => 'Πιστοποιήσεις & επιστημονικοί σύλλογοι.',
            'bio_memberships'         => "Δικηγορικός Σύλλογος Αθηνών | Ενεργό μέλος από 2005 | building\nΠαρ' Αρείω Πάγω | Ανώτατος βαθμός δικηγορίας | scale\nΈνωση Ελλήνων Εμπορικολόγων | Επιστημονική ένωση | badge\nΔιαπιστευμένη Διαμεσολαβήτρια | Υπουργείο Δικαιοσύνης | handshake",
            'bio_languages_eyebrow'   => 'Γλώσσες',
            'bio_languages_title'     => 'Επικοινωνία σε τρεις γλώσσες.',
            'bio_languages'           => "Ελληνικά | Μητρική | 100 |\nΑγγλικά | Άριστη γνώση | 95 | C2\nΓαλλικά | Πολύ καλή γνώση | 75 | C1",
            'bio_publications_eyebrow'=> 'Δημοσιεύσεις & ομιλίες',
            'bio_publications_title'  => 'Επιλεγμένες συμβολές στη νομική κοινότητα.',
            'bio_publications'        => "2022 | Άρθρο | Η εξέλιξη της νομολογίας στις τραπεζικές διαφορές | Νομικό Βήμα\n2019 | Ομιλία | Σύγχρονες προκλήσεις στο εργατικό δίκαιο | Συνέδριο ΔΣΑ\n2017 | Συμμετοχή | Δίκαιο των Συμβάσεων — συλλογικός τόμος | Νομική Βιβλιοθήκη\n2015 | Άρθρο | Διορθώσεις πρώτων εγγραφών στο Κτηματολόγιο | Δίκαιο & Ακίνητα",
            'bio_cta_eyebrow'         => 'Ραντεβού',
            'bio_cta_title'           => 'Επικοινωνήστε απευθείας με την {name}.',
            'bio_cta_lead'            => '<p>Πρώτη συνάντηση διάρκειας 30 λεπτών για να αξιολογήσουμε αν μπορώ να βοηθήσω. Διακριτική, εμπιστευτική, χωρίς χρέωση.</p>',
            'bio_cta_form_label'      => 'Φόρμα επικοινωνίας',
            'bio_cta_form_url'        => $contact_url,
        ),
    );
    ...
    foreach ( $defaults as $slug => $fields ) {
        ...
        foreach ( $fields as $key => $value ) {
            $current = get_field( $key, $page->ID );
            $is_empty = ( null === $current )
                || ( is_string( $current ) && '' === trim( $current ) )
                || ( is_array( $current ) && empty( $current ) );
            if ( $is_empty ) {
                update_field( $key, $value, $page->ID );
            }
        }
    }

    update_option( 'mourtzilaki_static_pages_seeded', $version );
}
